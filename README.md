...
[الموقع ودليل الاستخدام](https://cubecroom.cubetek.dev) منشوران على DigitalOcean App Platform. إعداد البناء والنشر في [.do/README.md](.do/README.md).
...
تتوفر الحزم المنشورة لـWindows x64 وmacOS لأجهزة Intel وApple Silicon وLinux x64 عبر [صفحة التنزيل](https://cubecroom.cubetek.dev/download/) و[GitHub Releases](https://github.com/cubetek/cubeCroom/releases)، دون حساب. تعرض صفحة التنزيل النسخة المستقرة إن وجدت، وإلا أحدث نسخة تجريبية، مع ملفاتها وبيانات التحقق المنشورة.

تُقرأ النسخ وتواريخها وملاحظاتها تلقائياً من GitHub في [سجل التغييرات](https://cubecroom.cubetek.dev/changelog/). راجع ملاحظات النسخة التي ستنزلها لمعرفة فحوصها وحدود التوقيع والتحديث؛ بصمات الملفات وإثبات مصدر البناء لا تمنحان ثقة نظام التشغيل. يتطلب الإصدار المستقر والتحديث الآلي إعداد التوقيع الموثق في [دليل النشر](scripts/release/README.md).
