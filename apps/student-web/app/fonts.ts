...
/**
 * خطّ بوابة الطالب — **النسخة نفسها التي في واجهة المعلّم**.
 *
 * والتعريف مكرَّر لا مشترك: `next/font` تحويلٌ في مُصرِّف Next لا مكتبة،
 * يُستدعى داخل كل تطبيق ومساراته حرفيّة عنده. فلا سبيل إلى استيراد نسخةٍ
 * واحدة — والبديل الوحيد أن يبقى أحد التطبيقين بلا خطّ.
 *
 * وما يجمعهما ليس هذا الملفّ بل الرموز: `--font-sans` في
 * `@cubecroom/ui/globals.css` تُسمّي العائلتين، فتباعُدُ الملفّين يظهر هناك.
 */
/**
